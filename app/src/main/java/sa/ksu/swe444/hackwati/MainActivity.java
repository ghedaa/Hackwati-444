...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void installButton110to250() {
        ...
        int[] drawable = {R.drawable.ic_menu_black_24dp, R.drawable.ic_power_settings_new_black_24dp, R.drawable.ic_account__24dp, R.drawable.ic_error_exclamation_outline_black_24dp, R.drawable.ic_mail_outline_black_24dp};// gray is some thing else
        int[] color = {R.color.yellow_hak, R.color.av_orange, R.color.blue_hak, R.color.pink_hak, R.color.colorAccent};
        for (int i = 0; i < 5; i++) {
